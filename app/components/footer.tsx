...
export default function Footer() {
  return (
    <section>
      <div>
        <div className="flex items-center mb-8 border-b-[1.5px] border-neutral-700 pb-4">
          <svg
          ...
          <Link
            href="/about#top-tracks"
            className="ml-2.5 text-neutral-300 hover:text-neutral-100"
          >
            My top 7 tracks
          </Link>
        </div>
